...
coqgen プロジェクトとは, OCamlという関数型言語の型推論の正しさを Coq で確認することを目標としたプロジェクトであり, 具体的には OCaml から Coq へのコンパイラの作成と, コンパイルされたプログラムに対する証明を行っている. 本章では, RAとして本プロジェクトに参加し得られた結果の一部を扱う. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
